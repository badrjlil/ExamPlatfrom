...
public class profDashboard extends javax.swing.JFrame {
    ...
    Enseignant ens;
    public profDashboard(Enseignant ens) {
        this.ens = ens;
        initComponents();
        this.setLocationRelativeTo(null);
        welcomeLabel.setText(welcomeLabel.getText() + " " + ens.getPrenom() + " " + ens.getNom());
    }
    ...
    private void initComponents() {
        ...
        jButton4.setText("Gestion des étudiants");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        new gestionMatieres(ens).setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(profDashboard.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                //new profDashboard().setVisible(true);
            }
        });
    }
